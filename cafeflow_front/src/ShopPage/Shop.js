...
function PlaceInfo({ cafeData }) {
  ...
  useEffect(() => {
    const fetchSeatInfo = async () => {
      try {
        const response = await axios.get(`/api/cafe/${idx}/seat`);
  ...
  return (
    <div data-viewid="basicInfoTop" data-root="">
      <div className="details_present" style={{ background: "none" }}>
        <a
          href="#none"
          className="link_present"
          data-logtarget=""
          data-logevent="info_pannel,main_pic"
        >
          <span
            className="bg_present"
            style={{ backgroundImage: "url(/img/cafelistimg.jpg)" }}
          ></span>
          <span
            className="bg_present"
          ...
          <div className="info">
            ...
            <div className="location_evaluation">
              <span className="txt_location">
                ...
                <a
                  href="#none"
                  className="link_evaluation"
                  data-cnt="9"
                  data-target="comment"
                  data-logtarget=""
                  data-logevent="info_pannel,point"
                >
                  <span className="color_b">{reviewsRating}</span>({reviewCount}
                  )
                </a>
              </span>
            </div>
          ...
          <div className="info_list">
            <div className="detail_placeinfo">
              ...
              <span class="info_revise">
                업데이트
                <span> | </span>
                <span class="date_revise">{updatedAt.split("T")[0]}</span>
              </span>
            </div>
            <div className="list_place">
              <div class="location_detail">
                ...
                <span class="txt_address">{address}</span>
              </div>
              <div class="location_detail">
                <h4 class="tit_detail">
...
function OwnerCertification() {
  ...
  return (
    <div className="place_details">
      <div className="inner_place">
        <IoIosCafe />
        <a className="admin_modify" href={`/modify/${idx}`}>
          관리자라면 가게를 관리하고 수정해보세요!
        </a>
      </div>
    </div>
  );
...
function Comment() {
  ...
  const handleSubmitReview = async () => {
    try {
      ...
      const response = await axios.post(`/api/cafe/${idx}/review`, formData, {
        headers,
      });
      let url = `/api/cafe/${idx}/review`;
      if (sortBy === "0") {
  ...
  return (
    <>
      <div className="place_details">
        <div className="inner_place">
          <div className="tit_subject">리뷰 사진</div>
          <br />
          <div>
      ...
      <div className="place_details">
        <div className="inner_place">
          <div className="review_with_rate">
            <div className="tit_subject">리뷰를 작성해보세요!</div>
      ...
      <div className="place_details">
        <div className="inner_place">
          <div className="tit_subject">리뷰 목록</div>
          <br />
...
const FindWay = () => (
  <div className="place_details">
    <div className="inner_place">
      <div className="tit_subject">찾아오시는 길</div>
      <br />
    </div>
  </div>
);
  ...
  return (
    <div className="container">
      <>
        ...
        <div className="place_details">
          <div className="inner_place">
            <div className="tit_subject">좌석 현황</div>
